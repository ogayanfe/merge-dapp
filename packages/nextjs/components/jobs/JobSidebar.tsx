...
export const JobSidebar = ({
  ...
  const sidebarClasses = `
    w-80 border-r border-base-300 flex flex-col h-full bg-base-200/95 backdrop-blur shadow-inner
    ...
    <>
      ...
      <aside className={sidebarClasses}>
        <div className="p-6 border-b border-base-300 flex justify-between items-center">
          <h2 className="text-xs font-black uppercase tracking-[0.2em] opacity-40 text-primary italic">
            Control Panel
          </h2>
          {/* Close Button Mobile */}
        ...
        {isArbiter && (
          <div className="px-6 mb-4 mt-4">
            <div className="bg-error/10 border border-error/20 p-2 rounded-sm text-center">
        ...
        {/* ... Rest of content starts from Tabs ... */}
